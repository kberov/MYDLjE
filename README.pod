...
=item 4 Make sure the server can wriite in forlders C<tmp>, C<log>,
 C<conf> and C<pub/home> in $MYDLjE_HOME.

=item 5 Use your browser to access B<index.xhtml> or setup via commandline -
 see L</SETUP>.
...
Many programmers prefer using a terminal. To set up the system this way,
 open a terminal and go to the MYDLjE root directory:
  ...
  you@yourcomputer:/pat/to/MYDLjE$ ./mydlje help system_setup
