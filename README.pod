...
Ado is already usable and on CPAN - see L<Ado|https://metacpan.org/release/Ado>.
The code repository is here L<https://github.com/kberov/Ado>.
Ado is much more modular and flexible than MYDLjE ant its name even means something :).
